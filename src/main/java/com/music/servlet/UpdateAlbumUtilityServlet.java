...
@WebServlet("/UpdateAlbumUtilityServlet")
public class UpdateAlbumUtilityServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher dis = request.getRequestDispatcher("edit-album.jsp");
