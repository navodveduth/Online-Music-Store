...
public class UpdateSongServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
		    ...
		    String track_des = request.getParameter("track_des");
		    String genre = request.getParameter("genre_tp");
		    String rlsdate = request.getParameter("release_date");
			...
			Part songName = request.getPart("song");
			String sgName = extractFileName(songName);
			// refines the song name
			sgName = new File(sgName).getName();
			songName.write(savePath + File.separator + sgName);

			updated = SongDBConnect.updatesong(songId, trackName, artist, track_des, imgName, genre, rlsdate, sgName, userId);
